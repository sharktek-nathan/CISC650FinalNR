 ...
 */
$config['site_title']                 = "RedFax.com";       // Site Title, example.com
$config['admin_email']                = "notify@sharktek.net"; // Admin Email, admin@example.com
...
/* Location: .lication/config/ion_auth.php */
