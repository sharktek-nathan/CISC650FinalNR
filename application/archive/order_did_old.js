$(document).ready(function() {
	...
	$('#city').on('change', function() {
		$('#available_numbers').html('<option value="">Select a fax number</option>');
		...
		invalidHandler: function(event, validator) {
			var errors = validator.numberOfInvalids();
				if (errors) {
					...
					? 'Please select a valid fax number before continuing!'
					: 'Please select a valid fax number before continuing!';
					$("#submit_check_one").html(message);
					$("#submit_check_one").show();
				} else {
					$("#submit_check_one").hide();
				}
			},
